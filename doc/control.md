# SLink Device Control

Use SLink to control Android devices with keyboard, mouse, and input modes.
...
[Previous: SLink Connections](connection.md) | [Next: SLink for Developers](develop.md)
