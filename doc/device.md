# SLink Device Options

Configure device-side options such as keep-active and stay-awake.
...
[Previous: SLink for Developers](develop.md) | [Next: SLink Gamepad](gamepad.md)
