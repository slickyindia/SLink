...
Configure video source, resolution, bitrate, FPS, and display behavior.
...
[Previous: Verify SLink Releases](verify-release.md) | [Next: SLink Virtual Display](virtual-display.md)
