#!/usr/bin/env bash
#
# This script generates the SLINK server binary "manually" (without gradle).
#
...
mkdir -p "$CLASSES_DIR"
mkdir -p "$GEN_DIR/com/slickyincorp/slink"

<< EOF cat > "$GEN_DIR/com/slickyincorp/slink/BuildConfig.java"
package com.slickyincorp.slink;

public final class BuildConfig {
  public static final boolean DEBUG = $SLINK_DEBUG;
  public static final String VERSION_NAME = "$SLINK_VERSION_NAME";
}
EOF
...
SRC=( \
    com/slickyincorp/slink/*.java \
    com/slickyincorp/slink/audio/*.java \
    com/slickyincorp/slink/control/*.java \
    com/slickyincorp/slink/device/*.java \
    com/slickyincorp/slink/display/*.java \
    com/slickyincorp/slink/model/*.java \
    com/slickyincorp/slink/opengl/*.java \
    com/slickyincorp/slink/util/*.java \
    com/slickyincorp/slink/video/*.java \
    com/slickyincorp/slink/wrappers/*.java \
)
