...
import com.slickyincorp.slink.util.Settings;
import com.slickyincorp.slink.util.SettingsException;
...
/**
 * Handle the cleanup of SLINK, even if the main process is killed.
 * <p>
 * This is useful to restore some state when SLINK is closed, even on device disconnection (which kills the SLINK process).
 */
