...
import com.slickyincorp.slink.display.DisplayPropertiesTracker;
import com.slickyincorp.slink.display.DisplayResizeDebouncer;
    ...
    public void startNew(Surface surface) {
        try {
            ...
            VirtualDisplay vd = ServiceManager.getDisplayManager()
                    .createNewVirtualDisplay("SLINK", displaySize.getWidth(), displaySize.getHeight(), dpi, surface, flags);
