...
import com.slickyincorp.slink.Workarounds;
...
public class AudioDirectCapture implements AudioCapture {
    ...
    private static void startWorkaroundAndroid11() {
        ...
        // But SLINK server is NOT an App, it's a Java application started from Android shell, so it has the same user ID (2000) with Android
        // shell ("com.android.shell").
        // If there is an Activity from Android shell running at foreground, then the permission system will believe SLINK is also in the
        // foreground.
