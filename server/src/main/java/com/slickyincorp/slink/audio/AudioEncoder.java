package com.slickyincorp.slink.audio;
...
import com.slickyincorp.slink.model.Codec;
import com.slickyincorp.slink.model.CodecOption;
import com.slickyincorp.slink.model.ConfigurationException;
import com.slickyincorp.slink.util.CodecUtils;
import com.slickyincorp.slink.util.IO;
...
public final class AudioEncoder implements AsyncProcessor {
    ...
    private void encode() throws IOException, ConfigurationException, AudioCaptureException {
        ...
        try {
            ...
            // Notify the error to make SLINK exit
