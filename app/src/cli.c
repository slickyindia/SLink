...
static const struct sc_option options[] = {
    {
        ...
        .text = "Make SLINK window always on top (above other windows).",
    },
    {
    ...
    },
    {
        ...
        .text = "Disable screensaver while SLINK is running.",
    },
    {
    ...
    },
    {
        ...
        .text = "Kill adb when SLINK terminates.",
    },
    {
    ...
    },
    {
        ...
        .longopt = "no-cleanup",
        .text = "By default, SLINK removes the server binary from the device "
    ...
    },
    {
        ...
        .text = "By default, SLINK automatically synchronizes the computer "
    ...
    },
    {
        ...
        .text = "By default, on MediaCodec error, SLINK automatically tries "
    ...
    },
    {
        ...
        .longopt = "no-window",
        .text = "Disable SLINK window. Implies --no-video-playback.",
    },
    {
    ...
    },
    {
        ...
        .text = "Turn the device screen off when closing SLINK.",
    },
    {
    ...
    },
    {
        ...
        .text = "By default, SLINK mirrors only the video when audio capture "
                "fails on the device. This option makes SLINK fail if audio "
    ...
    },
    {
        ...
        .argdesc = "seconds",
        .text = "Set the screen off timeout while SLINK is running (restore "
    ...
    },
    {
        ...
        .argdesc = "key[+...][,...]",
        .text = "Specify the modifiers to use for SLINK shortcuts.\n"
                "Possible keys are \"lctrl\", \"rctrl\", \"lalt\", \"ralt\", "
                "\"lsuper\" and \"rsuper\".\n"
                "Several shortcut modifiers can be specified, separated by "
                "','.\n"
                "For example, to use either LCtrl or LSuper for SLINK "
    ...
    },
    {
        ...
        .text = "Start an Android app, by its exact package name.\n"
                ...
                "    SLINK --new-display --start-app=+org.mozilla.firefox\n"
    ...
    },
    {
        ...
        .text = "Enable \"show touches\" on start, restore the initial value "
                "on exit.\n"
                "It only shows physical touches (not clicks from SLINK).",
    },
    {
        ...
        .text = "Configure and connect the device over TCP/IP.\n"
                "If a destination address is provided, then SLINK connects to "
                "this address before starting. The device must listen on the "
                "given TCP port (default is 5555).\n"
                "If no destination address is provided, then SLINK attempts "
    ...
    },
    {
        ...
        .longopt = "tunnel-host",
        .argdesc = "ip",
        .text = "Set the IP address of the adb tunnel to reach the SLINK "
    ...
    },
    {
        ...
        .longopt = "tunnel-port",
        .argdesc = "port",
        .text = "Set the TCP port of the adb tunnel to reach the SLINK "
                "server. This option automatically enables "
                "--force-adb-forward.\n"
    ...
    },
    {
        .shortopt = 'v',
        .longopt = "version",
        .text = "Print the version of SLINK.",
    },
    {
        .shortopt = 'V',
        .longopt = "verbosity",
    ...
    },
    {
        .shortopt = 'w',
        .longopt = "stay-awake",
        .text = "Keep the device on while SLINK is running, when the device "
                "is plugged in.",
    },
    {
...
void
SLINK_print_usage(const char *arg0) {
...
static bool
parse_args_with_getopt(struct SLINK_cli_args *args, int argc, char *argv[],
                       const char *optstring, const struct option *longopts) {
    struct SLINK_options *opts = &args->opts;
    ...
    if (!opts->video && !otg) {
        // If video is disabled, then SLINK must exit on audio failure.
        opts->require_audio = true;
    }
...
#ifdef _WIN32
/**
 * Attempt to detect whether the user launched SLINK by double-clicking
 * SLINK.exe in Windows Explorer.
 *
 * If so, the console should remain open on error.
 */
static bool
SLINK_launched_by_double_click(void) {
    // No console window
...
bool
SLINK_parse_args(struct SLINK_cli_args *args, int argc, char *argv[]) {
...
#ifdef _WIN32
        if (SLINK_launched_by_double_click()) {
